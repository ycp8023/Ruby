...
class StarsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create star" do
    assert_difference("Star.count") do
      post stars_url, params: { star: { product_id: @star.product_id, user_id: @star.user_id } }
    end
  ...
  test "should update star" do
    patch star_url(@star), params: { star: { product_id: @star.product_id, user_id: @star.user_id } }
